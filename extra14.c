...
/*
    ...
    Escreva um programa que imprima n termos compostos. Todo o número par é composto excetuando o número 2, pois é divisível somente por 1 e 2.
...
int main() // Função obrigatória
   {
    ...
    int i, k, num, qtddiv,qtdcompostos;
    ...
    printf("Digite a quantidade de valores compostos:");
    scanf("%d",&k);

	// Solicita que o usuário que entre com algum dado qualquer


    while(qtdcompostos<k){
